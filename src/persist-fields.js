/**
 * Extension to persist field values across page loads,
 * either to
 * 1) sessionStorage
 * 2) localStorage
 * 3) URL query string
 ...
 * 
 * Disabled or readonly fields are initialized from the store, but their values/changes aren't persisted.
 * 
 * Only values that differ from the default value are persisted, unless the field is marked 'required'
 ...
 * and matched back to the correct input based on type/pattern/length/readonly-value when initialized.
 * 
